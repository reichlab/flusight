...
** TODO Disable selection on legend
** TODO Legend metadata url click
*** Link icons for each prediction
SCHEDULED: <2016-11-08 Tue>
** TODO Max choropleth data across seasons
...
* Features
** TODO [#A] Gather historical data
SCHEDULED: <2016-11-07 Mon>
** TODO [#A] First run demo
SCHEDULED: <2016-11-07 Mon>
** TODO [#A] Allow option for choosing confidence interval
** Choropleth
...
* Enhancements
** TODO Colors to confidence ranges
